...
namespace NineSeven.LuceneNet.Service
{
    public class LuceneAnalyze : ILuceneAnalyze
    {
        ...
        /// <returns></returns>
        public string[] AnalyzerKey(string filed,string keyword)
        {
            Analyzer analyzer = new PanGuAnalyzer();
            QueryParser parser = new QueryParser(Lucene.Net.Util.Version.LUCENE_30, filed, analyzer);
