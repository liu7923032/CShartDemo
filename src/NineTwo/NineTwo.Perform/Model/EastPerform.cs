...
{
    public class EastPerform : AbsPerform,ICharge
    {

        public string East { get; set; } = "东派传人属性";
        public string filedEast = "东派传人字段";
        ...
        {
            Console.WriteLine($"{base.User}:谢谢大爷的赏钱,共:{money}{SYMBOL}"); 
        }
    }
}
